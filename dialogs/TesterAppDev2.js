      ...
      var date_invalid = false;
          console.log("001");
                ...
                if (args.entities.length> 0){ 
                    ...
                    for (b in args.entities)
                     {
                        if (args.entities[b].type == 'builtin.datetimeV2.daterange'){
 
                        session.userData['startdateT']  = args.entities[b].resolution.values[b].start; 
                        session.userData['enddateT']   = args.entities[b].resolution.values[b].end; 
                           
                        console.log("startdate",session.userData['startdateT'] );
                        console.log("enddate",session.userData['enddateT'] );
                        }
                     }                                      
